...
<div class="container">
    ...
    <div class="right-column">
        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras diam ex, gravida sed laoreet in, efficitur a
            elit. Quisque vitae nunc ipsum. Integer ac leo viverra, egestas metus id, gravida libero. Aenean tempus
            tortor quis augue facilisis volutpat. Aenean pretium pretium purus, a feugiat nisl ultrices eget. Duis
            vehicula congue pretium. In ultricies justo augue, nec euismod dui imperdiet et. Nullam mi justo, euismod et
            diam sed, aliquet pellentesque eros. Vestibulum pulvinar eros ut suscipit condimentum. Cras sit amet ligula
            ac sapien egestas aliquam. Integer sit amet accumsan tortor, nec aliquam ipsum.
        </p>
    </div>
</div>
</body>
